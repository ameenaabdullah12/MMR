...
$mod_strings = array (
  ...
  'LBL_ADDED_DASHLET' => ''.$sugar_config['acloudcrm_name'].' Dashlet Added',
  'LBL_ADDING_DASHLET' => 'Adding '.$sugar_config['acloudcrm_name'].' Dashlet ...',
  'LBL_ADD_BUSINESSCARD' => 'Enter Business Card',
  'LBL_ADD_DASHLETS' => 'Add '.$sugar_config['acloudcrm_name'].' Dashlets',
  ...
  'LBL_DASHLET_DELETE' => 'Delete '.$sugar_config['acloudcrm_name'].' Dashlet',
  'LBL_DASHLET_DISCOVER_SUGAR_PRO' => 'Discover '.$sugar_config['acloudcrm_name'].'',
  'LBL_DASHLET_EDIT' => 'Edit '.$sugar_config['acloudcrm_name'].' Dashlet',
  'LBL_DASHLET_OPT_HEIGHT' => 'Dashlet Height (in pixels)',
  'LBL_DASHLET_OPT_TITLE' => 'Title',
  'LBL_DASHLET_OPT_URL' => 'Website Location',
  'LBL_DASHLET_REFRESH' => 'Refresh '.$sugar_config['acloudcrm_name'].' Dashlet',
  'LBL_DASHLET_SEARCH' => 'Find '.$sugar_config['acloudcrm_name'].' Dashlet',
  'LBL_DASHLET_SUGAR_NEWS' => ''.$sugar_config['acloudcrm_name'].' News',
  ...
  'LBL_DETAILS_DEVSITE' => 'Discover resources, tutorials, and helpful links to get you up to speed on '.$sugar_config['acloudcrm_name'].' development',
  'LBL_DETAILS_FORUMS' => 'Discuss '.$sugar_config['acloudcrm_name'].' with expert community users and developers',
  'LBL_DETAILS_SUGAREXCHANGE' => 'Buy and sell certified '.$sugar_config['acloudcrm_name'].' extensions',
  'LBL_DETAILS_SUGARFORGE' => 'Collaborate and develop '.$sugar_config['acloudcrm_name'].' extensions',
  'LBL_DETAILS_TRAINING' => 'Learn about '.$sugar_config['acloudcrm_name'].' using online and interactive learning content',
  ...
  'LBL_GET_SUGARCRM_RSS' => 'Get '.$sugar_config['acloudcrm_name'].' RSS',
  'LBL_GLOBAL_REPORT_CHARTS' => 'Global Team Reports',
  'LBL_HOME_PAGE_1_NAME' => 'My '.$sugar_config['acloudcrm_name'].'',
  'LBL_HOME_PAGE_2_NAME' => 'Sales',
  'LBL_HOME_PAGE_3_NAME' => 'Support',
  'LBL_HOME_PAGE_4_NAME' => 'Tracker',
  'LBL_HOME_PAGE_6_NAME' => 'Marketing',
  'LBL_JOIN_SUGAR_COMMUNITY' => 'Join the '.$sugar_config['acloudcrm_name'].' Community',
  ...
  'LBL_LINK_CURRENT_CONTRIBUTORS' => 'Click this link for a current list of '.$sugar_config['acloudcrm_name'].' contributors!',
  'LBL_LIST_LAST_NAME' => 'Last Name',
  'LBL_MAX_DASHLETS_REACHED' => 'You have reached the maximum number of '.$sugar_config['acloudcrm_name'].' Dashlets your administrator has set. Please remove a '.$sugar_config['acloudcrm_name'].' Dashlet to add a new one.',
  'LBL_MODULES' => 'Modules',
  ...
  'LBL_POWERED_BY_SUGAR' => 'Powered By '.$sugar_config['acloudcrm_name'].'',
  'LBL_RELOAD_PAGE' => 'Please <a href="javascript: window.location.reload()">reload the window</a> to use this '.$sugar_config['acloudcrm_name'].' Dashlet.',
  'LBL_REMOVED_DASHLET' => ''.$sugar_config['acloudcrm_name'].' Dashlet Removed',
  'LBL_REMOVE_DASHLET_CONFIRM' => 'Are you sure you want to remove the '.$sugar_config['acloudcrm_name'].' Dashlet?',
  'LBL_REMOVING_DASHLET' => 'Removing '.$sugar_config['acloudcrm_name'].' Dashlet ...',
  ...
  'LBL_SOURCE_SUGAR' => ''.$sugar_config['acloudcrm_name'].' - The world&#39;s most popular sales force automation application created by '.$sugar_config['acloudcrm_name'].' Inc.',
  ...
  'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => ''.$sugar_config['acloudcrm_name'].' application notifications would go here.',
  ...
  'LBL_TOUR_WATCH' => 'Watch What&#39;s New in '.$sugar_config['acloudcrm_name'].'',
  'LBL_TOUR_WELCOME' => 'Welcome to '.$sugar_config['acloudcrm_name'].'',
  ...
  'LBL_TOUR_CALENDAR_URL_1' => 'Do you share your Access CRM calendar with 3rd party applications, such as Microsoft Outlook or Exchange? If so, you have a new URL. This new, more secure URL includes a personal key which will prevent unauthorized publishing of your calendar.',
...
The Help Dashboard is available for all Access CRM modules and can be toggled "open" and "closed" by clicking the Help icon in the application footer.';
$mod_strings['LBL_HELP_RECORD_TITLE'] = 'Welcome to the Access CRM Help Dashboard';
