...
if ( sugar_is_file('custom/include/images/sugar_md.png') ) {
    $login_image = '<IMG src="custom/include/images/sugar_md.png" style="margin-top: 20px; margin-bottom: 10px;" alt="Access">';
    
}
else {
    $login_image = '<IMG src="include/images/sugar_md_ent.png" style="margin-top: 20px; margin-bottom: 10px;" alt="Access">';
}
...
$sugar_smarty->display('custom/modules/Users/tpls/login.tpl'); ?>