...
{literal}
    EditView_tabs.addTab( new YAHOO.widget.Tab({
        label: '<div style="margin-top:6px"><i class="picon-spechbubble-sq-line-icon-16"></i><br/><em>{/literal}{$MOD.LBL_DOWNLOADS}{literal}</em></div>',
...
<div id="EditView_tabs" class="yui-navset">
    <ul class="yui-nav">		
        <li class="selected">			
			<a id="tab1" href="#tab1">
				<div>
					<i class="picon-spechbubble-sq-line-icon-16"></i>
					<br>
					<em>{$MOD.LBL_USER_INFORMATION}</em>
				</div>				
			</a>
		</li>
        <li {if $CHANGE_PWD == 0}style='display:none'{/if}>
			<a id="tab2" href="#tab2">
				<div>
					<i class="picon-spechbubble-sq-line-icon-16"></i>
					<br/>
					<em>{$MOD.LBL_CHANGE_PASSWORD_TITLE}</em>
				</div>					
			</a>
		</li>
        {if $SHOW_THEMES}
        <li>
			<a id="tab3" href="#tab3" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'>
				<div>
					<i class="picon-spechbubble-sq-line-icon-16"></i>
					<br/>
					<em>{$MOD.LBL_THEME}</em>
        ...
        {/if}
        <li>
			<a id="tab4" href="#tab4" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'>
				<div>
					<i class="picon-spechbubble-sq-line-icon-16"></i>
					<br/>
					<em>{$MOD.LBL_ADVANCED}</em>
				</div>				
			</a>
		</li>
        {if $ID}
        <li>
			<a id="tab5" href="#tab5" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'>
				<div>
					<i class="picon-spechbubble-sq-line-icon-16"></i>
					<br/>
					<em>{$MOD.LBL_EAPM_SUBPANEL_TITLE}</em>
				</div>
			</a>
		</li>
        {/if}
