...
<div style="text-align: center;" class="logon-centred-box">
  {$LOGIN_IMAGE}
  <h2>
      Login
      <br/>
      <small>Enter your email address and password to login</small>
  </h2>
					  ...
					  <td align="center">
						  <div class="login">
							  <form action="index.php" method="post" name="DetailView" id="form" onsubmit="return document.getElementById('cant_login').value == ''">
								  <table cellpadding="0" cellspacing="2" border="0" align="center" width="70%">
									  {if $LOGIN_ERROR !=''}
									  <tr>
                        ...
                        <br/>
                        <input type="text" size='35' tabindex="1" id="user_name" name="user_name"  value='{$LOGIN_USER_NAME}' />
                      </td>										  
									  </tr>
									  <tr>
										  <td scope="row" colspan="2"  width="100%">
                        ...
                        <br/>
                        <input type="password" size='26' tabindex="2" id="user_password" name="user_password" value='{$LOGIN_PASSWORD}' />
                      </td>										  
									  </tr>
