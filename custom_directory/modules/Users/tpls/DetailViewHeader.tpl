...
<div id="user_detailview_tabs" class="yui-navset detailview_tabs">
    <ul class="yui-nav">
        <li class="selected"><a id="tab1" href="#tab1">
          <div>
        ...
        <li {if $IS_GROUP_OR_PORTAL}style="display: none;"{/if}><a id="tab2" href="#tab2">
          <div>
            <i class="picon-spechbubble-sq-line-icon-16"></i>
            <br/>
        ...
        {if $SHOW_ROLES}
        <li><a id="tab3" href="#tab3">
          <div>
            <i class="picon-spechbubble-sq-line-icon-16"></i>
            <br/>
            <em>{$MOD.LBL_USER_ACCESS}</em>
          </div>          
        </a></li>
        {/if}
    </ul>
