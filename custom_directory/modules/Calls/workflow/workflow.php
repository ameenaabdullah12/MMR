...
class Calls_workflow {
 ...
 (isset($focus->status) && $focus->status ==  'Held')	 ){ 
	...
	if (!isset($triggeredWorkflows['2f5f1dc0_1654_11f0_837b_00163e6d1bc5'])){
		$triggeredWorkflows['2f5f1dc0_1654_11f0_837b_00163e6d1bc5'] = true;
		...
		$_SESSION['WORKFLOW_ALERTS']['Calls'] = isset($_SESSION['WORKFLOW_ALERTS']['Calls']) && ArrayFunctions::is_array_access($_SESSION['WORKFLOW_ALERTS']['Calls']) ? $_SESSION['WORKFLOW_ALERTS']['Calls'] : array();
		$_SESSION['WORKFLOW_ALERTS']['Calls'] = ArrayFunctions::array_access_merge($_SESSION['WORKFLOW_ALERTS']['Calls'],array ('Calls0_alert0',));	}
