...
$viewdefs['Campaigns']['DetailView'] = array (
  ...
  array (
    ...
    array (
      ...
      'links' => 
      array (
        0 => '{if $HAS_EDIT_ACCESS}<input type="button" class="button" onclick="javascript:window.location=\'index.php?module=Campaigns&action=WizardHome&record={$fields.id.value}\';" name="button" id="launch_wizard_button" value="{$MOD.LBL_TO_WIZARD_TITLE}" />{/if}',
  ...
  array (
    ...
    array (
      ...
      array (
        0 => 
        array (
          'name' => 'parent_campaign_c',
          'studio' => 'visible',
          'label' => 'LBL_PARENT_CAMPAIGN',
        ),
        1 => 
        array (
          'name' => 'impressions',
      ...
      array (
        ...
        1 => 
        array (
          'name' => 'a_emarketing_campaigntype_c',
          'label' => 'LBL_A_EMARKETING_CAMPAIGNTYPE',
        ),
      ),
      7 => 
      array (
        ...
        1 => 
        array (
          'name' => 'a_emarketing_refreshdate_c',
        ),
      ),
    ),
    'LBL_PANEL_ASSIGNMENT' => 
