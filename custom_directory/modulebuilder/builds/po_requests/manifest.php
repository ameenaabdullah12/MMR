...
$manifest = array (
  ...
  'name' => 'po_requests',
  'published_date' => '2023-02-15 10:51:57',
  'type' => 'module',
  'version' => 1676458317,
...
$installdefs = array (
  ...
  array (
    ...
    array (
      'module' => 'a_po_detail',
      'class' => 'a_po_detail',
      'path' => 'modules/a_po_detail/a_po_detail.php',
      'tab' => true,
    ),
    1 => 
    array (
      'module' => 'a_supplier',
      'class' => 'a_supplier',
      'path' => 'modules/a_supplier/a_supplier.php',
      'tab' => true,
    ),
    2 => 
    array (
      ...
      'class' => 'a_cost_centre',
      'path' => 'modules/a_cost_centre/a_cost_centre.php',
      'tab' => true,
    ),
    3 => 
    array (
      'module' => 'a_po_header',
      'class' => 'a_po_header',
      'path' => 'modules/a_po_header/a_po_header.php',
      'tab' => true,
    ),
  ),
  'layoutdefs' => 
  ...
  array (
    0 => 
    array (
      'from' => '<basepath>/SugarModules/modules/a_po_detail',
      'to' => 'modules/a_po_detail',
    ),
    1 => 
    array (
      'from' => '<basepath>/SugarModules/modules/a_supplier',
      'to' => 'modules/a_supplier',
    ),
    2 => 
    array (
      'from' => '<basepath>/SugarModules/modules/a_cost_centre',
      'to' => 'modules/a_cost_centre',
    ),
    3 => 
    array (
      'from' => '<basepath>/SugarModules/modules/a_po_header',
      'to' => 'modules/a_po_header',
    ),
  ),
  'language' => 
  array (
