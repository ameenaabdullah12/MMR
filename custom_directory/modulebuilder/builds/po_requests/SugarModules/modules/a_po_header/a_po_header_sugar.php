 ...
 * PLACE ANY CUSTOMIZATIONS IN a_po_header
 */

require_once 'include/SugarObjects/templates/sale/Sale.php';

class a_po_header_sugar extends Sale {
    public $new_schema = true;
    public $module_dir = 'a_po_header';
    public $object_name = 'a_po_header';
    public $table_name = 'a_po_header';
