 ...
 * PLACE ANY CUSTOMIZATIONS IN a_po_detail
 */

require_once 'include/SugarObjects/templates/sale/Sale.php';

class a_po_detail_sugar extends Sale {
    public $new_schema = true;
    public $module_dir = 'a_po_detail';
    public $object_name = 'a_po_detail';
    public $table_name = 'a_po_detail';
