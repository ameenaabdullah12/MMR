 ...
 * PLACE ANY CUSTOMIZATIONS IN a_supplier
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class a_supplier_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'a_supplier';
    public $object_name = 'a_supplier';
    public $table_name = 'a_supplier';
