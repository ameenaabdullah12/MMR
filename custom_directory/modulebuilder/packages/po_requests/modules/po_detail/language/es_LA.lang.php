...
$mod_strings = array (
  ...
  'LBL_SEARCH_FORM_TITLE' => 'Buscar PO Detail',
  ...
  'UPDATE_VERIFY_TXT' => 'Verifique que los valores en ventas sean números decimales válidos con caracteres numéricos (0-9) y decimales(.) únicamente.',
  ...
  'UPDATE_DOLLARAMOUNTS_TXT' => 'Actualice los valores en dólares estadounidenses para las ventas, en base a las tasas de cambio actuales. Este valor se usa para calcular Valores de Moneda en Gráficos y Listas.',
  ...
  'UPDATE_MERGE_TXT' => 'Unifique múltiples monedas en una única moneda. Si existen múltiples registros de moneda para la misma moneda, puede unificarlas. Esto también unificará las monedas para el resto de módulos.',
  'LBL_ACCOUNT_NAME' => 'Nombre de Cuenta:',
  'LBL_AMOUNT' => 'Cantidad:',
  'LBL_AMOUNT_USDOLLAR' => 'Cantidad en Dólares Estadounidenses:',
  'LBL_CURRENCY' => 'Moneda:',
  ...
  'MSG_DUPLICATE' => 'El registro de Venta que está a punto de crear podría ser un duplicado de otro registro de Venta existente. Los registros de Venta con nombres similares se enumeran a continuación.<br>Haga clic en Guardar para continuar con la creación de esta nueva Venta, o en Cancelar para volver al módulo sin crear la venta.',
  'LBL_NEW_FORM_TITLE' => 'Nuevo PO Detail',
  'LNK_NEW_SALE' => 'Crear Venta',
  'LNK_SALE_LIST' => 'Venta',
  'ERR_DELETE_RECORD' => 'Debe de especificar un número de registro para eliminar la venta.',
  'LBL_TOP_SALES' => 'Mis Ventas Abiertas Principales',
  ...
  'LBL_CLOSED_WON_SALES' => 'Ventas Concretadas',
  ...
  'LBL_HOMEPAGE_TITLE' => 'Mi PO Details',
  'LNK_NEW_RECORD' => 'Crear PO Detail',
  'LNK_LIST' => 'Vista PO Details',
