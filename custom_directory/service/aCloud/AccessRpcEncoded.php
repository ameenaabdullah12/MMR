 ...
 */
$http_plain_url=str_replace("https://","http://",$GLOBALS['sugar_config']['site_url']);
return <<<EOT
...
<definitions xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tns="http://www.sugarcrm.com/sugarcrm" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns="http://schemas.xmlsoap.org/wsdl/" targetNamespace="http://www.sugarcrm.com/sugarcrm">
    ...
    <xsd:import namespace="http://schemas.xmlsoap.org/soap/encoding/" schemaLocation="{$http_plain_url}/service/soap-encoding.xsd"/>
    <xsd:import namespace="http://schemas.xmlsoap.org/wsdl/" schemaLocation="{$http_plain_url}/service/wsdl.xsd"/>
    ...
    <xsd:complexType name="module_mapping_value_list">
    <xsd:all>
    <xsd:element name="name" type="xsd:string"/>
    <xsd:element name="on_deletes" type="xsd:boolean"/>
    </xsd:all>
    </xsd:complexType>
    <xsd:complexType name="field_mapping_value_list">
    <xsd:all>
    <xsd:element name="name" type="xsd:string"/>
    <xsd:element name="on_inserts" type="xsd:boolean"/>
    <xsd:element name="on_updates" type="xsd:boolean"/>
    </xsd:all>
    </xsd:complexType>
    <xsd:complexType name="field_mappings_value_list">
    <xsd:complexContent>
    <xsd:restriction base="SOAP-ENC:Array">
    <xsd:attribute ref="SOAP-ENC:arrayType" wsdl:arrayType="tns:field_mapping_value_list[]"/>
    </xsd:restriction>
    </xsd:complexContent>
    </xsd:complexType>
    </xsd:schema>
    ...
    <part name="return" type="tns:get_entry_result_for_reports"/>
    </message>
    ...
    <part name="return" type="tns:modified_relationship_result"/>
    </message>
    <message name="change_statusRequest">
    <part name="session" type="xsd:string"/>
    <part name="module_name" type="xsd:string"/>
    <part name="from_status" type="xsd:string"/>
    <part name="to_status" type="xsd:string"/>
    <part name="id" type="xsd:string"/>
    </message>
    <message name="change_statusResponse">
    <part name="return" type="xsd:boolean"/>
    </message>
    <message name="change_statusesRequest">
    <part name="session" type="xsd:string"/>
    <part name="module_name" type="xsd:string"/>
    <part name="from_status" type="xsd:string"/>
    <part name="to_status" type="xsd:string"/>
    <part name="ids" type="tns:str_array"/>
    </message>
    <message name="change_statusesResponse">
    <part name="return" type="xsd:boolean"/>
    </message>
    <message name="execute_viewRequest">
    <part name="session" type="xsd:string"/>
    <part name="module_name" type="xsd:string"/>
    <part name="view_name" type="xsd:string"/>
    <part name="where_query" type="xsd:string"/>
    <part name="order_by" type="xsd:string"/>
    <part name="select_fields" type="tns:select_fields"/>
    <part name="offset" type="xsd:int"/>
    <part name="max_results" type="xsd:int"/>
    <part name="deleted" type="xsd:boolean"/>
    </message>
    <message name="execute_viewResponse">
    <part name="return" type="tns:get_entry_list_result_version2"/>
    </message>
    <message name="save_entryRequest">
    <part name="session" type="xsd:string"/>
    <part name="module_name" type="xsd:string"/>
    <part name="name_value_list" type="tns:name_value_list"/>
    <part name="update_fields" type="tns:str_array"/>
    </message>
    <message name="save_entryResponse">
    <part name="return" type="tns:new_set_entry_result"/>
    </message>
    <message name="save_entriesRequest">
    <part name="session" type="xsd:string"/>
    <part name="module_name" type="xsd:string"/>
    <part name="name_value_lists" type="tns:name_value_lists"/>
    <part name="update_fields" type="tns:str_array"/>
    </message>
    <message name="save_entriesResponse">
    <part name="return" type="tns:new_set_entries_result"/>
    </message>
    <message name="save_mappingRequest">
    <part name="session" type="xsd:string"/>
    <part name="module_value_list" type="tns:module_mapping_value_list"/>
    <part name="fields_value_list" type="tns:field_mappings_value_list"/>
    </message>
    <message name="save_mappingResponse">
    <part name="return" type="xsd:boolean"/>
    </message>
    <message name="loginAndImpersonateRequest">
    <part name="user_auth" type="tns:user_auth"/>
    <part name="application_name" type="xsd:string"/>
    <part name="impersonateUserEmail" type="xsd:string"/>
    <part name="name_value_list" type="tns:name_value_list"/>
    </message>
    <message name="loginAndImpersonateResponse">
    <part name="return" type="tns:entry_value"/>
    </message>
    ...
    <operation name="change_status">
    <input message="tns:change_statusRequest"/>
    <output message="tns:change_statusResponse"/>
    </operation>
    <operation name="change_statuses">
    <input message="tns:change_statusesRequest"/>
    <output message="tns:change_statusesResponse"/>
    </operation>
    <operation name="execute_view">
    <input message="tns:execute_viewRequest"/>
    <output message="tns:execute_viewResponse"/>
    </operation>
    <operation name="save_entry">
    <input message="tns:save_entryRequest"/>
    <output message="tns:save_entryResponse"/>
    </operation>
    <operation name="save_entries">
    <input message="tns:save_entriesRequest"/>
    <output message="tns:save_entriesResponse"/>
    </operation>
    <operation name="save_mapping">
    <input message="tns:save_mappingRequest"/>
    <output message="tns:save_mappingResponse"/>
    </operation>
    <operation name="loginAndImpersonate">
    <input message="tns:loginAndImpersonateRequest"/>
    <output message="tns:loginAndImpersonateResponse"/>
    </operation>
    </portType>
    <binding name="sugarsoapBinding" type="tns:sugarsoapPortType">
    <soap:binding style="rpc" transport="http://schemas.xmlsoap.org/soap/http"/>
    <operation name="login">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/login" style="rpc"/>
    <input>
    ...
    <operation name="logout">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/logout" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_entry">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_entry" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_entries">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_entries" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_entry_list">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_entry_list" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="set_relationship">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/set_relationship" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="set_relationships">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/set_relationships" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_relationships">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_relationships" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="set_entry">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/set_entry" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="set_entries">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/set_entries" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_server_info">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_server_info" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_user_id">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_user_id" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_module_fields">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_module_fields" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="seamless_login">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/seamless_login" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="set_note_attachment">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/set_note_attachment" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_note_attachment">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_note_attachment" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="set_document_revision">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/set_document_revision" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_document_revision">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_document_revision" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="search_by_module">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/search_by_module" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_available_modules">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_available_modules" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_user_team_id">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_user_team_id" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="set_campaign_merge">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/set_campaign_merge" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_entries_count">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_entries_count" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_report_entries">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_report_entries" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_module_fields_md5">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_module_fields_md5" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_last_viewed">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_last_viewed" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_upcoming_activities">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_upcoming_activities" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="get_modified_relationships">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/get_modified_relationships" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="change_status">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/change_status" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="change_statuses">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/change_statuses" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="execute_view">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/execute_view" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="save_entry">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/save_entry" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="save_entries">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/save_entries" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="save_mapping">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/save_mapping" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <operation name="loginAndImpersonate">
    <soap:operation soapAction="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php/loginAndImpersonate" style="rpc"/>
    <input>
    <soap:body use="encoded" namespace="http://www.sugarcrm.com/sugarcrm" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
    </input>
    <output>
    ...
    <soap:address location="{$GLOBALS['sugar_config']['site_url']}/custom/service/aCloud/soap.php"/>
    </port>
    </service>
    </definitions>
EOT;
