...
$mod_strings['LBL_PROJECT_CALC'] = 'Project calc';
$mod_strings['LBL_PROJECT_STATUS_CALC'] = 'Project status calc';
$mod_strings['LBL_PROJECT_STATUS_ERROR'] = 'Project Status Error';
$mod_strings['LBL_PROJECT_COMMISSION_DATE'] = 'Project commission date';
$mod_strings['LBL_PO_LINK'] = 'PO link';
$mod_strings['LBL_PO_LINK_URL'] = 'po link url';
$mod_strings['LBL_PO_LINK_URL_CORRECT'] = 'po link url correct';
$mod_strings['LBL_INVOICED_VALUE'] = 'Invoiced value';
$mod_strings['LBL_PO_HEADER_STATUS'] = 'PO header status';
$mod_strings['LBL_SYNC_ERROR'] = 'Sync Error';
$mod_strings['LBL_RECEIVE_VALUE_QUEUED'] = 'Receive Value Queued';
$mod_strings['LBL_CANCEL_LINE'] = 'Cancel Line';
$mod_strings['LBL_CC_FILTER'] = 'CC Filter';
$mod_strings['LBL_C_PO_DETAIL_RECORD_DASHBOARD'] = 'Purchase Order Details Record Dashboard';
$mod_strings['LBL_C_PO_DETAIL_FOCUS_DRAWER_DASHBOARD'] = 'Purchase Order Details Focus Drawer';
