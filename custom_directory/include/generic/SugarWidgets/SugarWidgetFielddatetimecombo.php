...
// MMR Customization - We are using the Custom file instead of main file - which is the only change
require_once 'custom/include/generic/SugarWidgets/SugarWidgetFielddatetime.php';
// MMR Customization - end
